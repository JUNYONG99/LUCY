...
function snsShare(type, title, url, img) {
    ...
    if (type == "facebook") {
        ...
        //shareUrl = "http://band.us/plugin/share?body=" + encodeURIComponent(title) + encodeURIComponent('\n') + encodeURIComponent(url);
        //encodeURIComponent(StringTool.format('{0}\n{1}', title, url));
        //var encodeRoute = encodeURIComponent(window.location.href);
        //shareUrl = StringTool.format('http://band.us/plugin/share?body={0}&route={1}', encodeBody, encodeRoute);
        shareUrl = "http://band.us/plugin/share?body=" + encodeURIComponent(title) + encodeURIComponent("\n") + encodeURIComponent(url);
